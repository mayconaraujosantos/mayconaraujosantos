...
import com.c6bak.finappguaranteecardreceivables.domain.dataaccess.CardReceivablesScheduleToTableMapper
...
class CardReceivablesScheduleDataAccessImpl(
  ...
  override fun findSchedulesByTaxIdentifier(
    ...
    return repository.findAll(spec).map { CardReceivablesScheduleTableToDomainMapper.map(it) }
  }
  ...
  override fun findByCompositeKey(
          register: String,
          arrangement: String,
          accreditor: String,
          source: String,
    ...
    val spec =
            CardReceivablesScheduleFilters.byCompositeKey(
                    register,
                    arrangement,
                    accreditor,
                    source,
  ...
  override fun saveSchedules(schedules: List<CardReceivablesSchedule>) {
    val entities = schedules.map { CardReceivablesScheduleToTableMapper.map(it) }
...
interface CardReceivablesScheduleRepository :
  ...
  fun saveCardReceivablesSchedule(
          entity: CardReceivablesScheduleTable

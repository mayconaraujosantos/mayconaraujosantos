...
class CardReceivablesScheduleDataAccessImplTest {
  ...
  private fun buildCardReceivablesSchedule(
          id: String = DEFAULT_ID,
          taxIdentifier: String = DEFAULT_TAX_IDENTIFIER,
          register: String = DEFAULT_REGISTER,
  ...
  fun `should save schedules correctly`() {
    val schedules =
            listOf(buildCardReceivablesSchedule(id = "10", taxIdentifier = "99999999999999"))
...
class CardReceivablesScheduleFiltersTest {
  ...
  // Mantém os testes de assertNotNull para garantir cobertura básica
  @Test
